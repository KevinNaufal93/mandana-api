...
export class InitialSchema1785429145684 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."properties_listing_type_enum" AS ENUM('sale', 'rent')`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_089e10e6f1282e7b4bd0c58263" ON "properties"  ("slug") `);
        ...
        await queryRunner.query(`ALTER TABLE "inquiries" ADD CONSTRAINT "FK_fb8f767d33104c829ea4eabeca6" FOREIGN KEY ("property_id") REFERENCES "properties"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_089e10e6f1282e7b4bd0c58263"`);
        await queryRunner.query(`DROP TABLE "properties"`);
        await queryRunner.query(`DROP TYPE "public"."properties_status_enum"`);
        await queryRunner.query(`DROP TYPE "public"."properties_listing_type_enum"`);
