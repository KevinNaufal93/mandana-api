...
| Page images (fixed-slot images on a static page — today: Tentang Kami) | `/admin/page-images/:slotKey` | `/page-images` | [page-images-admin-integration.md](page-images-admin-integration.md) |
